...
export const policyUploadingTemplate: DatabaseTable = {
  ...
  columns: [
    {
      name: "client_id",
      displayName: "policies:client_id",
      dataType: "INT",
      required: true,
      description: "Reference to the client this policy is issued to",
    },
    {
      ...
      displayName: "policies:ref_policy_number",
      dataType: "VARCHAR",
      required: false,
      maxLength: 30,
    ...
    {
      name: "partner_id",
      displayName: "policies:partner_id",
      dataType: "INT",
      required: true,
    ...
    {
      name: "product_id",
      displayName: "policies:product_id",
      dataType: "INT",
      required: true,
      description: "Reference to the insurance product",
    },
    {
      name: "effective_date",
      displayName: "policies:effective_date",
      dataType: "DATE",
      required: true,
      description: "Date the policy becomes effective",
    },
    {
      name: "expiration_date",
      displayName: "policies:expiration_date",
      dataType: "DATE",
      required: true,
      description: "Date the policy expires",
    },
    {
      name: "currency_code",
      displayName: "policies:currency_code",
      dataType: "VARCHAR",
      required: true,
      maxLength: 30,
    ...
    {
      name: "currency_rate",
      displayName: "policies:currency_rate",
      dataType: "DECIMAL",
      required: true,
    ...
    {
      name: "payment_frequency",
      displayName: "policies:payment_frequency",
      dataType: "ENUM",
      required: true,
      description:
    ...
    {
      name: "coverage_amount",
      displayName: "policies:coverage_amount",
      dataType: "DECIMAL",
      required: true,
      description: "Maximum coverage amount provided by the policy",
    },
    {
      name: "deductible_amount",
      displayName: "policies:deductible_amount",
      dataType: "DECIMAL",
      required: true,
      description: "Deductible amount applicable for claims",
    },
    {
      ...
      displayName: "policies:insured_properties",
      dataType: "TEXT",
      required: false,
    ...
    {
      name: "underwriting_notes",
      displayName: "policies:underwriting_notes",
      dataType: "TEXT",
      required: false,
  ...
  additionalColumns: [
    ...
    },
    {
      ...
      defaultValue: "1",
      description: "Indicates whether the policy is set to auto-renew",
      displayName: "policies:auto_renewal",
    },
  ],
};
